...
<div class="profile-left">
    <img src="assets/zmz_headshot.jpg" alt="Mingzhang Zhu" class="profile-img">
    <h2 class="profile-name">Mingzhang (Norman) Zhu</h2>
  <p style="margin-bottom: 0.5rem;">Email: normanzmz@g.ucla.edu</p>
...
<div class="proj-row">
  <div class="proj-media">
    ...
    <!-- A) Image -->
    <img src="Project/Cosmo/cosmo_project.jpg" alt="Cosmo demo">
  ...
  <div class="proj-text">
    ...
    <p><a class="md-button" href="Project/Cosmo/cosmo/">More Info</a></p>
  </div>
</div>
